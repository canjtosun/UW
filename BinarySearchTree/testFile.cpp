...
//// --------------------------------------------------------------------------------------------------------------------
//// Purpose - This file is to test assignment operators,
//// constructor, destructor, insert, find the height of given node
////build tree, copt tree to array and vice versa.
//// --------------------------------------------------------------------------------------------------------------------
//
//
//#include "bintree.h"
...
//	cout << "Created T2: " << T2 << endl;
//	cout << "Created dup: " << dup << endl;
//
//	cout << "---------------------------------" << endl;
//
//	cout << "Created T: isEmpty? " << T.isEmpty() << endl;
//	cout << "Created T2: isEmpty? " << T2.isEmpty() << endl;
//	cout << "Created dup: isEmpty? " << dup.isEmpty() << endl;
//
//	cout << "---------------------------------" << endl;
//
...
//	cout << endl;
//	cout << "---------------------------------" << endl;
//	cout << "Builded T: " << T << endl;
//
//	cout << "---------------------------------" << endl;
//
//	BinTree first(T);                  // test copy constructor
//
//	cout << "first created and chec if copied" << first << endl;
//
//	dup = dup = T;                     // test operator=, self-assignment
//
//	cout << "---------------------------------" << endl;
//
//	cout << "check assignment operator is working dup:  " << dup << endl;
//	cout << "check assignment operator is working T:  " << T << endl;
//
//	cout << "---------------------------------" << endl;
//	cout << "---------------------------------" << endl;
//	cout << "---------------------------------" << endl;
